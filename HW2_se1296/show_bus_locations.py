...
# The first three sections are taken from the NYC Weather API example, adjusted for the MTA data parameters. https://github.com/fedhere/PUI2016_fb55/blob/master/Lab2_fb55/NYCweatherAPI.py
...
# I got these two lines of code from Sebastian, sbg389 (https://github.com/sbg389/PUI2016_sbg389/blob/master/HW2_sbg389/show_bus_locations_sbg389.py). I understood what needed to be done as far as getting to a specific element, but was having trouble getting the correct path through the dictionaries/lists.
...
#I knew a for loop was necessary, but again struggled with specifying the correct path to Lat/Lon. Took that from Sebastian's script, but formatted my own print statement.
